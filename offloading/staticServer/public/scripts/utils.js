...
function getCSV(statistics, fileName) {
    let csvContent = statistics.map(e => e.join(",")).join("\n");
...
export { Camera, Video, onFrame, isMobile, isIOS, getScreenOrientation, resize2cover, rad2deg, deg2rad, getCSV, Queue, roughSizeOfObject }